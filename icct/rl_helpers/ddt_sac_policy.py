...
from stable_baselines3.common.policies import BasePolicy, ContinuousCritic, register_policy, get_policy_from_name    
...
from icct.rl_helpers.sb3_compat import (
...
class DDTActor(BasePolicy):
    ...
    def __init__(
        ...
        if ddt_kwargs.get('use_oblique', False):
            self.ddt = ObliqueTree(input_dim=features_dim,
                                   output_dim=action_dim,
                                   num_leaves=ddt_kwargs['num_leaves'],
        ...
        if self.use_sde:
            ...
            if sde_net_arch is not None:
                if create_sde_features_extractor is None:
                    raise ImportError(
                        "create_sde_features_extractor not found in stable_baselines3.common.policies. "
                        "This feature requires stable-baselines3 >= 1.1.0."
                    )
