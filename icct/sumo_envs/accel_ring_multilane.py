...
vehicles.add(
    ...
    car_following_params=SumoCarFollowingParams(
        min_gap=2.5,  # to avoid crashing and teleportation. Need more verification
        max_speed=12
    ),
...
ring_accel_lc_params_visual = deepcopy(ring_accel_lc_params)
ring_accel_lc_params_visual["sim"].render = True
