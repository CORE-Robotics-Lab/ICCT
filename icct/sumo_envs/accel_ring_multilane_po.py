...
from flow.envs.ring.lane_change_accel import LaneChangeAccelPOEnv
...
class LaneChangeAccelPOEnv_Wrapper(LaneChangeAccelPOEnv):
...
ring_accel_lc_po_params = dict(
    # name of the experiment
    exp_tag="stabilizing_the_ring",

    # name of the flow environment the experiment is running on
    env_name=LaneChangeAccelPOEnv_Wrapper,
...
ring_accel_lc_po_params_visual = deepcopy(ring_accel_lc_po_params)
ring_accel_lc_po_params_visual["sim"].render = True
