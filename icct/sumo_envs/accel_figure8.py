...
# Revised from https://github.com/flow-project/flow/blob/master/examples/exp_configs/rl/singleagent/singleagent_figure_eight.py
...
fig8_params_visual = deepcopy(fig8_params)
fig8_params_visual["sim"].render = True
