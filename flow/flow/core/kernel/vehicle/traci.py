...
class TraCIVehicle(KernelVehicle):
    ...
    def update_vehicle_colors(self):
        ...
        """
        if "disable_rl_vehicle_auto_coloring" not in self.sim_params.__dict__ or ("disable_rl_vehicle_auto_coloring" in self.sim_params.__dict__ and not self.sim_params.disable_rl_vehicle_auto_coloring):
            for veh_id in self.get_rl_ids():
                try:
